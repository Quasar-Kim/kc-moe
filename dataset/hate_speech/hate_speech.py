...
class HateSpeech(GeneratorBasedBuilder):
    ...
    def _info(self):
        return DatasetInfo(
            ...
            features=features.FeaturesDict({
                'text': features.Text(),
                'label': features.ClassLabel(names=['none', 'offensive', 'hate'])
            })
        )
    ...
    def _generate_examples(self, split):
        url = f'gs://kds-258505083a16ad29d33a74d5c2dacc78743d11e7ade0fa5e527206d9/dataset/parquet/hate-speech/{split}.parquet'
